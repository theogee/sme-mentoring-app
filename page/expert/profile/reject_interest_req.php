...
<head>
	...
	<title>Reject Interest Request</title>
	<link rel="stylesheet" href="../../../css/general/general.css">
	<link rel="stylesheet" href="../../../css/expert/profile/reject_interest_req.css">
</head>
<body>
	<main>
		...
		<p class="confirmation-text">You can't recover this request page once you reject it. Do you want to procede?</p>
		<button id="delete-yes">yes</button>
		<button id="delete-no">no, go back</button>
	</main>

	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
   	<script src="../../../js/expert/profile/reject_interest_req.js?v=<?php echo time(); ?>"></script>
</body>
</html>