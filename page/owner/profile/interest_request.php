<?php 
	...
	$_SESSION["requestID"] = $requestID = (int) $_GET["requestID"];
...
<head>
	...
	<link rel="stylesheet" href="../../../css/owner/profile/interest_request.css?v=<?php echo time() ?>">
</head>
<body data-request-id="<?php echo $requestID ?>" data-sender-info="owner-<?php echo $row['owner_id'].'-'.$row['owner_name'] ?>" data-recepient-info="<?php echo $row['expert_id'] ?>" data-scope="ir">
	<header>
		<nav>
	...
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
   	<script src="../../../js/owner/profile/interest_request.js?v=<?php echo time(); ?>"></script>
