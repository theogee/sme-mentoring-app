...
<head>
	...
	<title>Close Interest Request</title>
	<link rel="stylesheet" href="../../../css/general/general.css">
	<link rel="stylesheet" href="../../../css/owner/profile/close_interest_req.css">
</head>
<body>
	<main>
	...
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
   	<script src="../../../js/owner/profile/close_interest_req.js?v=<?php echo time(); ?>"></script>
</body>
</html>