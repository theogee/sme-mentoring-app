...
<head>
	...
	<link rel="stylesheet" href="../../../css/owner/mentor_room/add_resources.css">
</head>
<body data-room-id="<?php echo $roomID ?>" data-poster-id="<?php echo $ownerID ?>">
	<header>
		<nav>
	...
	<script src="../../../js/owner/mentor_room/add_resources.js?v=<?php echo time(); ?>"></script>
</body>
</html>