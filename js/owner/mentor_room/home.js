...
$(document).ready(() => {
	...
	$("#close-btn").on("click", () => {
		window.location = "close_confirmation.php";
	});
});
...
function getBusinessPage(pageID) {
	$.get("../../../utility/functions.php", {
		...
		<div>
			...
			<a class="business-page-link" href="../profile/business_page.php?pageID=${response.pageID}&pageTitle=${response.businessName}">Full Page</a>
		</div>`;
